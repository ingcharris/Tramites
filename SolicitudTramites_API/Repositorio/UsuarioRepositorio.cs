    ...
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public async Task<UsuarioDto> Registrar(RegistroRequestDTO registroRequestDTO)
        {
            UsuarioAplicacion usuario = new()
            {
                ...
                UsuarioNombre = registroRequestDTO.UsuarioNombre,
                UsuarioTipoDocumento = registroRequestDTO.UsuarioTipoDocumento,
                UsuarioNroDocumento = registroRequestDTO.UsuarioNroDocumento,
                UsuarioDireccion = registroRequestDTO.UsuarioDireccion,
            };
