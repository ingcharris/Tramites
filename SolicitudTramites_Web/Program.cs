using SolicitudTramites_Web;
using SolicitudTramites_Web.Services;
...
builder.Services.AddHttpClient<ITramitesService, TramitesService>();
builder.Services.AddScoped<ITramitesService, TramitesService>();

builder.Services.AddHttpClient<IPrediosService, PrediosService>();
